...
<h4>Efectividad del <code>XX</code>%</h4>
<h5>Desglose</h5>
<p>Correcta: <code>[cuántas de las <?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> respuestas tienen puntaje 1]</code></p>
<p>Casi Correcta: <code>[cuántas de las <?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> respuestas tienen puntaje 2]</code></p>
<p>Dudosa: <code>[cuántas de las <?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> respuestas tienen puntaje 3]</code></p>
<p>Incorrecta: <code>[cuántas de las <?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> respuestas tienen puntaje 4]</code></p>
<p>Significado Opuesto: <code>[cuántas de las <?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> respuestas tienen puntaje 5]</code></p>
<p>Sin Respuesta: <code>[cuántas de las <?echo (count($json_data['test']['pictogramas'][$a]['respuestas']))?> respuestas tienen puntaje 6]</code></p>
